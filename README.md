...
This module implements a **demineur** game designed to be hosted on the **Azure Container Apps** infrastructure provisioned via Terraform.
...
#### 1.  **New Game Request:**
The Frontend sends a request to start a new game:
```bash
GET /new-game?difficulty=easy

```
#### 2.  **Backend Processing:**
* Generates an empty grid
* Places mines while excluding the protected zone
* Computes the numbers for each non-mine cell
...
```
#### 3.  **Frontend Logic:**
* Displays a hidden grid
* Reveals cells on left click
* Automatically expands empty areas using flood fill
